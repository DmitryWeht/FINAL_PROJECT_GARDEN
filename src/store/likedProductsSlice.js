...
const likedProductsSlice = createSlice({
    ...
    reducers: {
        ...
        deleteFromLikedProducts(state, action) {
            ...
            state.likedProducts = state.likedProducts.filter(item => item.id !== productIdToRemove);
...
export const { addToLikedProducts, deleteFromLikedProducts, getQuantity } = likedProductsSlice.actions;
